...
//CODE HERE
let empOne = new Employee(`Tyler`, `weekday nights, Sunday morning`)
/*
...
class Manager extends Employee {
    ...
    getEmployees(){
        console.log(`${this.name} mananges ${this.employees}`)
    }
    addEmployees(emp){
...
//CODE HERE
let manager = new Manager(`Tina`, `monday-friday open to close`, [`Cece `,`Schmidt`])
