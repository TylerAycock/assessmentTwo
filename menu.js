...
const pizza = {
    ...
    number: 2,
    rating: 9.5,
    tags: [`Dave's picks`, `gluten free`, `kids`]
}
...
//CODE HERE
// let pizaPopulatiry = pizza.number 
console.log(pizza.number)
/*
...
const foodArr = [
   {
        name: `Mountain of Pasta`,
        price: 25,
        category: `Entree`,
        number: 3,
        rating: 8,
        tags: [`carb heaven`, `cheese`, `add meatballs`]
    },
    {
        name: `Bowl of Salad `,
        price: 18,
        ...
        number: 5,
        rating: 6,
        tags: [`helthy`, `vegan`, `boring`]
    },
    {
        name: `Worlds best omelette`,
        price: 15,
        category: `Breakfast`,
        number: 1,
        rating: 10,
        tags: [`yummy`, `gluten extra`, `eggs`]
    }
]
...
let onlyBreakfast = foodArr.filter(function(obj){
    return obj.tags.includes(`yummy`)
})
...
//property will be a string rating, popularity, or price)
//will be the number that you want to compare against 
